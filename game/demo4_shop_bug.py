...
LEVELS = {
    1: {"level_color": GREEN, "with_spikes": False, "with_bad_mushrooms": False, "moving_mushrooms": False, "with_enemy": False, "with_chest": True},
    2: {"level_color": GREEN2, "with_spikes": True, "with_bad_mushrooms": False, "moving_mushrooms": False, "with_enemy": False, "with_chest": False},
    3: {"level_color": GREEN3, "with_spikes": False, "with_bad_mushrooms": True, "moving_mushrooms": False, "with_enemy": False, "with_chest": False},
    4: {"level_color": GREEN4, "with_spikes": False, "with_bad_mushrooms": False, "moving_mushrooms": False, "with_enemy": True, "with_chest": False},
    5: {"level_color": GREEN, "with_spikes": False, "with_bad_mushrooms": False, "moving_mushrooms": True, "with_enemy": False, "with_chest": False},
}
...
class Assets:
    ...
    def Key(self):
        # Check if with_chest is True before trying to use self.key
        if self.with_chest and self.key:
            k = self.key
    ...
    def Chest(self):
        # Check if with_chest is True before trying to use self.chest
        if self.with_chest and self.chest:
            c = self.chest
