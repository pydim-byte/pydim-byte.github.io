...
class Assets:
    ...
    def Player(self):
        ...
        #pygame.draw.polygon(win, BLACK, ((200, 150), (185, 180), (215, 180)))
    ...
    while running:
        ...
        for s, rect in zip(spikes, assets.spike_rects):  # Correct access to spike_rects
            if player.colliderect(rect):  # Check collision with bounding rect
                spikes.remove(s)  # Remove spike on collision
                assets.spike_rects.remove(rect)  # Remove corresponding rect
                score += 1  # Increase score
